 ...
 * @access Private
 */
router.post("/profile-image", authenticateJWT, multerProfileImage.single("image"), authController.uploadProfileImage);
 ...
 * @access Private
 */
router.delete("/profile-image", authenticateJWT, authController.deleteProfileImage);
