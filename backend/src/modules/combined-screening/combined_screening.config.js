...
export default {
   ...
   */
  schedules: [
    { time: "06:00", modules: ["rekon_virtual_mrg", "penyesuaian", "rekon_sales"], enabled: false, description: "Pagi - Rekon Virtual, Penyesuaian, Rekon Sales" },
    { time: "12:15", modules: ["rekon_virtual_mrg", "penyesuaian", "rekon_sales"], enabled: false, description: "Siang - Rekon Virtual, Penyesuaian, Rekon Sales" },
    { time: "20:00", modules: ["prep_closing", "rekon_wt_harian"], enabled: false, description: "Malam - Prep Closing + WT Harian" },
  ],
