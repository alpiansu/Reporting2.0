...
export default {
  ...
  queries: {
    ...
    store: `SELECT (SELECT KIRIM FROM toko) AS CAB, (SELECT KDTK FROM toko) AS SHOP, TANGGAL, PRDCD, SINGKATAN, QTY_MSTRAN, QTY_MTRAN, QTY_MSTRAN - QTY_MTRAN AS SEL, NOW(), '' AS KET FROM (
